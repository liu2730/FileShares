...
#sys.path.append(os.path.join(mount_directory, '/home/liu_fl/Downloads/photon-master/python_codes'))
#import modify_plt_settings
#import loadmat_functions

# import path containing image generation code
py_path = '/home/liu_fl/Downloads/photon-master/python_codes/'

...
def create_simulation_parameters(simulation_type):
    ...
    simulation_parameters['camera_design']['pixel_gain'] = 50 #25
    ...
    if simulation_type == 'piv':
        ...
        # % This adds the grid point diameter to the structure
        simulation_parameters['bos_pattern']['grid_point_diameter'] = 6.0e1
        # % This adds the grid point number to the calibration structure
        ...
        # option to specify dot spacing in pixels (if the dis is regular)
        simulation_parameters['bos_pattern']['dot_spacing'] = 1.0
    ...
    simulation_parameters['density_gradients']['density_gradient_filename'] = '/home/liu_fl/Downloads/photon-master/sample-data/bos/sample-density.nrrd' #jhu_buoy_turb_t=8.00_zoff=0.75pi

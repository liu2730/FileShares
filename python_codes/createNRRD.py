...
'''
data['x'] = np.linspace(-15e3,15e3,nx).astype('float32') - X_Velocity/2
data['y'] = np.linspace(-15e3,15e3,ny).astype('float32') - Y_Velocity/2
...
nrrd_filename = '/home/liu_fl/Downloads/photon-master/sample-data/bos/real-density.nrrd'
